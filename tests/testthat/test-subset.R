...
test_that("subset.mcmcr", {
  expect_identical(pars(subset(mcmcr_example, parameters = rev(pars(mcmcr_example)))), rev(pars(mcmcr_example)))
...
test_that("subset.mcmcrs", {
  ...
  expect_identical(pars(subset(mcmcrs, parameters = rev(pars(mcmcrs)))), rev(pars(mcmcrs)))
