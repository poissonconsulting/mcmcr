...
test_that("rhat.mcmcrs", {
  expect_identical(rhat(mcmcrs(mcmcr_example, mcmcr_example)), list(mcmcr1 = 1, mcmcr2 = 1))
  expect_identical(rhat(mcmcrs(mcmcr_example, mcmcr_example), by = "parameter"),
                   list(mcmcr1 = list(alpha = 1, beta = 1, sigma = 1),
                        mcmcr2 = list(alpha = 1, beta = 1, sigma = 1)))
})
